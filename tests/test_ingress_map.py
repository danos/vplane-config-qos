...
TEST_DATA = [
    (
        ...
        # expected_result
        [
            ("qos 0 ingress-map in-map-1 pcp 0",
             "qos 0 ingress-map in-map-1 pcp 0 designation 0 drop-prec green",
            "ALL"),
            ("qos 0 ingress-map in-map-1 pcp 1",
             "qos 0 ingress-map in-map-1 pcp 1 designation 1 drop-prec yellow",
            "ALL"),
            ("qos 0 ingress-map in-map-1 pcp 2",
             "qos 0 ingress-map in-map-1 pcp 2 designation 2 drop-prec red",
            "ALL"),
            ("qos 0 ingress-map in-map-1 pcp 3",
             "qos 0 ingress-map in-map-1 pcp 3 designation 3 drop-prec red",
            "ALL"),
            ("qos 0 ingress-map in-map-1 pcp 4",
             "qos 0 ingress-map in-map-1 pcp 4 designation 4 drop-prec yellow",
            "ALL"),
            ("qos 0 ingress-map in-map-1 pcp 5",
             "qos 0 ingress-map in-map-1 pcp 5 designation 5 drop-prec green",
            "ALL"),
            ("qos 0 ingress-map in-map-1 pcp 6",
             "qos 0 ingress-map in-map-1 pcp 6 designation 6 drop-prec green",
            "ALL"),
            ("qos 0 ingress-map in-map-1 pcp 7",
             "qos 0 ingress-map in-map-1 pcp 7 designation 7 drop-prec yellow",
            "ALL"),
            ("qos 0 ingress-map in-map-1 complete",
             "qos 0 ingress-map in-map-1 complete",
             "ALL"),
            ("qos 0 ingress-map in-map-2 dscp-group group-1",
             "qos 0 ingress-map in-map-2 dscp-group group-1 designation 0 drop-prec green",
            "ALL"),
            ("qos 0 ingress-map in-map-2 dscp-group group-2",
             "qos 0 ingress-map in-map-2 dscp-group group-2 designation 1 drop-prec green",
            "ALL"),
            ("qos 0 ingress-map in-map-2 dscp-group group-3",
             "qos 0 ingress-map in-map-2 dscp-group group-3 designation 2 drop-prec green",
            "ALL"),
            ("qos 0 ingress-map in-map-2 dscp-group group-4",
             "qos 0 ingress-map in-map-2 dscp-group group-4 designation 2 drop-prec yellow",
            "ALL"),
