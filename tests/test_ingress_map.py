    ...
    (
        ...
        [
            ("qos 0 ingress-map in-map-1 pcp 0",
             "qos 0 ingress-map in-map-1 pcp 0 designation 0"),
            ("qos 0 ingress-map in-map-1 pcp 1",
             "qos 0 ingress-map in-map-1 pcp 1 designation 1"),
            ("qos 0 ingress-map in-map-1 pcp 2",
             "qos 0 ingress-map in-map-1 pcp 2 designation 2"),
            ("qos 0 ingress-map in-map-1 pcp 3",
             "qos 0 ingress-map in-map-1 pcp 3 designation 3"),
            ("qos 0 ingress-map in-map-1 pcp 4",
             "qos 0 ingress-map in-map-1 pcp 4 designation 4"),
            ("qos 0 ingress-map in-map-1 pcp 5",
             "qos 0 ingress-map in-map-1 pcp 5 designation 5"),
            ...
            ("qos 0 ingress-map in-map-2 dscp-group group-2",
             "qos 0 ingress-map in-map-2 dscp-group group-2 designation 1"),
